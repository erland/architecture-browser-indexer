...
final class JavaTypeNodeSemanticsSupport {
    private final JavaJpaTypeSemanticsSupport jpaTypeSemanticsSupport;

    JavaTypeNodeSemanticsSupport(JavaRelationshipEvidenceEmitter relationshipEvidenceEmitter) {
        this.jpaTypeSemanticsSupport = new JavaJpaTypeSemanticsSupport(relationshipEvidenceEmitter);
    }
    ...
    void applyTypeSemantics(ExtractionAccumulator accumulator, JavaTypeContext typeContext) {
        ...
        jpaTypeSemanticsSupport.addJpaTypeMetadata(accumulator, typeContext);
    }
    ...
    void addJpaInheritanceFacts(
        ...
        jpaTypeSemanticsSupport.addJpaInheritanceFacts(
            accumulator,
            relativePath,
            packageName,
            typeNode,
