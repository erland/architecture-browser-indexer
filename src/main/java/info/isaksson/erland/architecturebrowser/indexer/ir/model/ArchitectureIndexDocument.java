...
public record ArchitectureIndexDocument(
    ...
    @JsonInclude(JsonInclude.Include.NON_EMPTY) Map<String, Object> dependencyViews,
    ...
    public ArchitectureIndexDocument(
        ...
        this(schemaVersion, indexerVersion, runMetadata, source, scopes, entities, relationships, null, null, diagnostics, completeness, metadata);
    }
    ...
    public ArchitectureIndexDocument {
        ...
        dependencyViews = dependencyViews == null ? null : Map.copyOf(dependencyViews);
