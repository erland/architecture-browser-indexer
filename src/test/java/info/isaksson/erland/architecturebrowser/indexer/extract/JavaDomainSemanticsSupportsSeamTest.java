...
class JavaDomainSemanticsSupportsSeamTest {
    ...
    void preservesStableJavaSemanticsContractsAcrossSplitDomainSupports() {
        ...
        var observed = JavaCdiDomainSemanticsSupport.detectCdiObservedEvent(observerMethod, "").orElseThrow();
        ...
        Map<String, String> variableTypes = JavaWritePathDetectionSupport.collectMethodVariableTypes(
            writePathMethod,
        ...
        assertEquals("OrderEntity", JavaWritePathDetectionSupport.resolveWriteTargetEntityType("saved", variableTypes).orElseThrow());
    }
}
